...
[ ] Step 6: Generate goals + trackers + mandatory habits from approved manifesto; add review/approve UI.
[ ] Step 7: Implement PDF export (manifesto, goals, trackers, habits).
[ ] Step 8: Add polish: privacy messaging, loading/empty states, navigation entry, and QA pass.
